    ...
    <div class="container">
        <?php
            foreach ($harga_buku as $harga) { ?>
                <div class="text-center"><img src="<?php echo base_url() ?>uploads/<?=$baca->gambar;?>" alt="" width = "200px" class="text-center m-auto" ></div><br>
                 <h2><b><p class="text-center"><?=$harga->judul;?></p></b></h2>
                 <p class="text-center"><?=$harga->author;?></p>
                 <p class="text-center"><?=$harga->tanggal;?></p>
                 <br><br>
                 <div class="container"><p class="text-center"><?=$harga->isi;?></p></div>
                 <br>
            <?php }
        ?>
    </div>
